...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['pass']))
{
	...
	$verify_code = substr(str_shuffle($str), 0, 10);
	...
	{		
		mysqli_query($db->connect(),"insert into users(name,email,password,verify_code,verified,permission) values('$name','$email','$pass','$verify_code','no',0)");
